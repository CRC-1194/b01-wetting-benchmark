...
namespace functionObjects
{
    ...
    addToRunTimeSelectionTable(functionObject, vortex2d, dictionary);
}
}
...
const Foam::Enum
<
    Foam::functionObjects::vortex2d::modeType
>
Foam::functionObjects::vortex2d::modeTypeNames
({
    { functionObjects::vortex2d::modeType::MYVORTEX2D, "myvortex2D" },
});


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::functionObjects::vortex2d::setPhi(const volVectorField& U)
{
...
Foam::functionObjects::vortex2d::vortex2d
(
    const word& name,
    const Time& runTime,
...
bool Foam::functionObjects::vortex2d::read(const dictionary& dict)
{
...
bool Foam::functionObjects::vortex2d::execute()
{
    volVectorField* Uptr =
...
bool Foam::functionObjects::vortex2d::write()
{
