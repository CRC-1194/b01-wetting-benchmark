...
Help()
{
   ...
   echo "*./reproduce_DropletSpreadingTest_MeshConvergence.sh [fluid] [contact_angle]"
   echo
   echo "E.g., for water_gylcerol, run ./reproduce_DropletSpreadingTest_MeshConvergence.sh water_glycerol 50"
   echo "options:"
